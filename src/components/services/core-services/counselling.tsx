...
export default function CounsellingSection() {
    const body = (<>
        <p>Starick recognises that counselling is an important part of the recovery process both during and after experiencing family and domestic violence. We also recognise that counselling for children affected by family and domestic violence is equally important, and helps break the cycle of violence.</p>
        <br></br>
    ...
    return <ServicesSection titleTextColour="[--starick-white]" titleBackgroundColour="[--starick-green]" sectionBody={body} title="Counselling Services" iconPath="icons/speech.svg"/>
}