...
export default function ResourceForSchools() {
  const subbody = (
    <>
      <p className="text-lg my-4">Teaching and learning:</p>
      <ol className="list-inside list-decimal">
        ...
        <li>  
          <Link
            ...
            className="my-link"
          >
            Background teacher notes</Link> – respectful relationships
        </li>
        <li>  
          <Link
            ...
            className="my-link"
          >
            Learning activities</Link>: Kindergarten – Year 10 
        </li>
        <li>  
          <Link
            ...
            className="my-link"
          >
            RELATE: Respectful relationships education program</Link> Years 7 – 10
        </li>
        <li>
          ...
          <Link
            ...
            className="my-link"
          >Teach respectful relationships</Link>
        </li>
        <li>
          ...
          <Link
            ...
            className="my-link"
          >Respectful Relationships</Link>
        </li>
      </ol>
      <p className="text-lg my-4">Policy and practice:</p>
      <ol className="list-inside list-decimal">
        <li>Our Watch</li>
        <li>
        ...
        <li>
          ...
          <Link
            ...
            className="my-link"
          >gender equality policy template</Link>
        </li>
      </ol>
      <p className="text-lg my-4">School culture and environment:</p>
      <ol className="list-inside list-decimal">
        <li>Our Watch</li>
        <li><Link
            href="https://education.ourwatch.org.au/resource/school-baseline-assessment-tool-staff/"
            className="my-link"
          >School baseline assessment tool: Staff</Link></li>
        <li>School baseline assessment tool: Student (<Link
            href="https://education.ourwatch.org.au/resource/school-baseline-assessment-tool-student-versions/"
            className="my-link"
          >primary school</Link>)</li>
        <li>Student baseline assessment template (<Link
            href="https://education.ourwatch.org.au/resource/school-baseline-assessment-tool-student-versions/"
            className="my-link"
          >secondary school</Link>)</li>
      </ol>
    </>
  );
  const body = (
