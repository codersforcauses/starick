  ...
  const subbody1 = (
    <>
      <div className="ml-8">
        ...
        <br />
        <p>
          Starick&apos;s Safe at Home program is available to any woman living
          in our catchment area who is experiencing domestic or family violence
          and wants to remain in her own home.
        </p>
        <br />
        <p>
  ...
  const subbody2 = (
    <>
      <div className="ml-8">
        ...
        <br />
        <p>
          Our Safe at Home outreach workers can assist you in the following
          ways:
        </p>
        <br />
        <List
  ...
  const subbody3 = (
    <>
      <div className="ml-8">
        ...
        <br />
        <p>
          Any woman living in the following suburbs can use Starick&apos;s Safe
          at Home program:
        </p>
        <br />
        <p>
          ...
          Glen Forrest, Gooseberry Hill, Hacketts Gully, High Wycombe, Hovea,
          Jane Brook, Kalamunda, Kensington, Kewdale, Lathlain, Lesmurdie,
          Mahogany Creek, Maida Vale, Mundaring, Parkerville, Paulls Valley,
          Perth, Perth Airport, Piesse Brook, Redcliffe, Rivervale, South
          Kalamunda, St James, Stoneville, Victoria Park, Walliston, Wattle
          Grove and Welshpool.
        </p>
      </div>
    </>
