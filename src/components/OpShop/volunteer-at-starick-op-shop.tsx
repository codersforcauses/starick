...
export default function VolunteerAtStarickOpShop() {
  const subbody = (
    <>
      <p>
      Volunteers are the lifeblood of the Starick Op Shop, 
      which is run entirely by our team of dedicated volunteers. 
      </p>
      <p>
      You can choose to work one day or more, and rest assured that 
      op shop manager Sandy Hunt will make you feel welcome. 
      </p>
      <p>
      ...
      <br />
      <p>
      Please call our head office on (08) 9478 5300
      </p>
