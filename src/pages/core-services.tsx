...
export default function CoreServices() {
    const refugeSupportExamples = ["Emotional support", 
                                    "Information and referral to relevant services", 
                                    "Counselling",
                                    "Case management",
                                    "Conducting risk assessments",
                                    "Safety plans"].map(text => <li className="list-disc list-inside">{text}</li>);

    const childrenServicesExamples = ["Emotional support", 
                                    "Referral to relevant services", 
                                    "Counselling",
                                    "Out-of-school activities and school holiday programs",
                                    "Homework support",
                                    "Art-related activities."].map(text => <li className="list-disc list-inside">{text}</li>)

    return (
        <>
            <div className="h-10 text-center bg-[--starick-green]">Navbar - replace with component later</div>
            <div className="bg-neutral-200 flex flex-col justify-center items-center px-20">
            ...
            <div className="bg-neutral-200 flex flex-col justify-center items-center px-20">
                ...
                <div>
                    ...
                    <br></br>
                    <ul>{childrenServicesExamples}</ul>
                    <br></br>
