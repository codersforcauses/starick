...
export default function ChildSafeResources() {
    ...
    return (
        <>
            ...
            <div className="px-20 py-10 md:px-40 md:py-20 lg:px-60">
                <ChildSafeItem backgroundColor="olive" text="UN Convention on the Rights of the Child"/>
            ...
            <div className="px-20 py-10 md:px-40 md:py-20 lg:px-60">
                ...
                <ChildSafeItem backgroundColor="white" text="Commonwealth Child Safe Framework"/>
                <ChildSafeItem backgroundColor="olive"
                ...
                <ChildSafeItem backgroundColor="white" text="Commonwealth Child safe framework 2nd edition"/>
