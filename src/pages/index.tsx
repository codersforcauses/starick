  ...
  return (
    <>
      ...
      <div className="bg-starick-olive py-2 pl-6 text-center font-bold text-starick-brown  ">
        <p dangerouslySetInnerHTML={{ __html: homeData['acf']['index_title_span'] }}>
      ...
      <div className="flex items-center pb-20 pt-20">
        ...
        <p className=" white-space-normal mx-36 ml-auto w-1/3 text-right  text-2xl font-semibold text-starick-brown" dangerouslySetInnerHTML={{ __html: homeData['acf']['index_supporting'] }}>
