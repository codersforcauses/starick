...
export default function Donation() {
  const containerBody = (
    <>
      <div>
        <div className="mb-10">
          <p>
            You can donate your refund to Starick using the Starick SCHEME ID :
            C10289306
          </p>
        </div>
        <div className="flex flex-col justify-center">
          <div className="w-3/4">
            ...
            <ol className="ml-6 list-decimal text-start">
              <li className="mb-3">
                Find your closest point at the containers for change website
              </li>
              <li className="mb-3">
                Collect eligible drink containers (check the label to see if it
                carries 10c return information)
              </li>
              <li className="mb-3">Take your containers to the refund point</li>
              <li className="mb-3">
                Use the Starick Scheme ID C10289306. You can also download our
                barcode for scanning by clicking below
              </li>
              <li className="mb-3">
                The donation is sent directly to Starick from the refund point
              </li>
            </ol>
          </div>
  ...
  const donateServices = (
    <div className="text-start">
      <p className="mb-3 ">
        Your organisation or community group can help us improve the wellness
        and quality of life of the women and children in our service.
      </p>
      <p className="mb-8">
        Donated services could include providing a regular gardening service,
        offering yoga classes, providing us with health club memberships for our
        clients or teaching our clients a skill to help them become independent,
        such as cooking classes and self defence.{" "}
      </p>
    ...
    <div className="mb-10 flex justify-center">
      <div style={{ maxWidth: "70%" }}>
        ...
        <div className="grid grid-cols-3">
          ...
          <div className="col-span-2 mb-8 text-start">
            <p className="mb-5">
              Like Vivienne Stewart and Mandy Loton, you could fund a family
              camp or other activity for women and their children.
            </p>
            <p className="mb-5">
              Vivienne and Mandy fund a good, old-fashioned family camp in
              country WA. Their donation provides women and their children with
              some time out and a range of activities to build self-confidence
              and strengthen relationships between mothers and their children.
              For many families, the camp is their first holiday away together.
            </p>
          </div>
          ...
          <div className="col-span-2 mb-8 text-start">
            <p className="mb-5">
              You could follow the lead of the New Apostolic Church in Rivervale
              WA, and provide goods to a family for a year to help them get back
              on their feet.
            </p>
            <p className="mb-5">
              This local church group sponsors a family with a fortnightly food
              hamper and gifts for birthdays and other special occasions.
            </p>
          </div>
          <p className="col-span-1 text-xl font-bold">
          ...
          <div className="col-span-2 mb-8 text-start">
            <p className="mb-5">
              You could run a fundraising campaign amongst your friends or
              colleagues and donate the funds to Starick - it&apos;s easy to do
              via our charity page on Gofundraise.
            </p>
            <p className="mb-5">
              We receive donations from organisations, individuals and community
              groups who support our services throughout the year, and who also
              schedule fundraising events on our behalf.
            </p>
            <p className="mb-5">
              Need some ideas? Here are some examples of individuals and groups
              who donated the proceeds of their event to us:
            </p>
          </div>
        </div>
        <div className="text-start">
          <p className="mb-8 text-xl font-bold">
            Take inspiration from some previously run fundraisers
          </p>
        </div>
        <div className="mb-10 text-start">
          <p>
            ...
            Southern River College held a sausage sizzle fundraiser - Sundowners
            Ladies Golf Club hosted a fundraising lunch - Gelo, a local
            promotions organisation, organised a Craptastic fundraising quiz
            night - WA Poets ran a performance poetry event and donated the door
            takings
          </p>
        </div>
      </div>
  ...
  const donateContainers = (
    <div>
      <div className="text-start">
        <p className="mb-5">
          WA&apos;s new container deposit scheme aims to reduce litter and
          increase recycling of beverage containers by offering 10c refunds on
          every eligible contained returned (including cans, plastic and glass
          bottles, but not wine bottles).
        </p>
        <p className="mb-8">
          You can donate your refund to Starick using the Starick SCHEME ID:
          C10289306.
  ...
  const donateStock = (
    <div>
      <p className="mb-3 text-start">
        Our Op Shop is run by a dedicated team of volunteers and we are always
        on the lookout for donations of stock.
      </p>
      ...
      <div className="w-5/6">
        ...
        <div>
          <p className="text-start">
            ...
            <br />
            TO STARICK SERVICES INC, ABN 56 721 993 085
            <br />
            PO BOX 174
            <br />
            CLOVERDALE WA 6985
  ...
  return (
    <>
      ...
      >
        <p className="text-xl font-bold text-starick-white">
          All donations over $2 are tax deductible.
        </p>
        <p className="mt-5 text-base text-starick-white">
          Starick is registered as a charity with the Australian Charities and
          Not-for-profits Commission, ABN 56 721 993 085.
        </p>
      </div>
      <PageSummary
        content={
      ...
      <PageHeaderBigCircle
        ...
        socialMedia={false}
      />
      <div className="flex justify-center bg-starick-olive text-center">
        <div>
          <p className="my-10 text-2xl font-bold">
          ...
          <div>
            <p className="mb-8">
              Any financial donation no matter how small can assist us to
              enhance and increase the support we are able to provide to women
...
function Summary({ title, text, textColour }: SummaryProps) {
  return (
    <div className="flex flex-col items-center">
      <p className={`text-center text-xl font-semibold text-${textColour}`}>
        {title}
      </p>
      <div className={`text-center text-${textColour}`}>{text}</div>
    </div>
  );
}
